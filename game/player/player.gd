...
var possible_upgrades: Array[Upgrade] = [
	...
	Upgrade.new(Enum.UPGRADE.RANGE, Enum.UPGRADE_METHOD.ABSOLUTE, 0.4, Enum.RARITY.COMMON),
	...
	Upgrade.new(Enum.UPGRADE.RANGE, Enum.UPGRADE_METHOD.ABSOLUTE, 0.8, Enum.RARITY.UNCOMMON),
	Upgrade.new(Enum.UPGRADE.DAMAGE, Enum.UPGRADE_METHOD.ABSOLUTE, 10, Enum.RARITY.UNCOMMON),
	...
	Upgrade.new(Enum.UPGRADE.RANGE, Enum.UPGRADE_METHOD.ABSOLUTE, 1.2, Enum.RARITY.RARE),
	Upgrade.new(Enum.UPGRADE.DAMAGE, Enum.UPGRADE_METHOD.ABSOLUTE, 20, Enum.RARITY.RARE),
	...
	Upgrade.new(Enum.UPGRADE.RANGE, Enum.UPGRADE_METHOD.ABSOLUTE, 1.8, Enum.RARITY.EPIC),

...
var areas = [
	...
	},
	{
		...
		levels = {
			0: ["V01","V02","V06","V07","V13","V14"],
			1: ["V01_D1","V02_D1","V06_D1","V07_D1","V08","V09","V11","V12","V13_D1","V14_D1"],
			2: ["V01_D2","V02_D2","V06_D2","V07_D2","V08_D2","V09_D2","V11_D2","V12_D2","V13_D2","V14_D2"],
			3: ["V01_D3","V02_D3","V06_D3","V07_D3","V08_D3","V09_D3","V11_D3","V12_D3","V13_D3","V14_D3"],
		},
		boss_levels = {
			0: "VB01",
			1: "VB01",

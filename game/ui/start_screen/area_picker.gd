...
var areas = [
	{
		...
		levels = {
			...
			3: ["J01_D3", "J02_D3", "J03", "J04_D3", "J05_D3", "J06", "J07_D3", "J08", "J10_D3", "J15_D3", "J16_D3", "J17_D3", "J19_D3"],
		},
		boss_levels = {
			0: "JB00",
			1: "JB01",
	...
	},
	{
		...
		levels = {
			...
			2: ["V01_D2","V02_D2","V06_D2","V07_D2","V08_D2","V09_D2","V11_D2","V12_D2","V13_D2","V14_D2","V17_D2","V18_D2","V19","V22_D2","V23","V24","V05_D2","V20_D2","V21_D2"],
			3: ["V01_D3","V02_D3","V06_D3","V07_D3","V08_D3","V09_D3","V11_D3","V12_D3","V13_D3","V14_D3","V17_D3","V18_D3","V19","V22_D3","V24","V05_D3","V20_D3","V21_D3"],
		},
		boss_levels = {
			0: "VB01",
			1: "VB01",
	...
	
	{
		...
		levels = {
			...
			2: ["B01_D2", "B02_D2", "B03_D2", "B04_D2", "B05_D2", "B06_D2", "B07_D2", "B08_D2", "B09_D2", "B10_D2", "B12_D2", "B13_D2", "B15_D2", "B16_D2", "B17_D2", "B18_D2", "B19_D2", "B20_D2"],
			3: ["B01_D3", "B02_D3", "B03_D3", "B04_D3", "B05_D3", "B06_D3", "B07_D3", "B08_D3", "B09_D3", "B10_D3", "B12_D3", "B13_D3", "B15_D3", "B16_D3", "B17_D3", "B18_D3", "B19_D3", "B20_D3"],
		},
		boss_levels = {
			0: "BB00",
			1: "BB01",

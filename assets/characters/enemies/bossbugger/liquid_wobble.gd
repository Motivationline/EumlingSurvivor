...
@export var liquid_height:= 3.0:
	set(value):
		liquid_height = value
		change_liquid_height(liquid_height)
...
func change_liquid_height(_height:float):
	material_override.set_shader_parameter("liquid_height",_height)
